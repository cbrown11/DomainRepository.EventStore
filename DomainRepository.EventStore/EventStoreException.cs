...
{
    [Serializable]
    public class EventStoreException : System.Exception
    {
        public EventStoreException() { }
        public EventStoreException(string message) : base(message) { }
        public EventStoreException(string message, System.Exception inner) : base(message, inner) { }
    ...
    public class EventStoreAggregateNotFoundException : EventStoreException
    {
        ...
        public EventStoreAggregateNotFoundException(string message, System.Exception inner) : base(message, inner) { }
    ...
    public class EventStoreCommunicationException : EventStoreException
    {
        ...
        public EventStoreCommunicationException(string message, System.Exception inner) : base(message, inner) { }
